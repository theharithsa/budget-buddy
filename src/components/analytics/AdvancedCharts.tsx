        ...
        <div className="bg-card rounded-lg shadow border border-border p-6">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm font-normal text-muted-foreground">Active Categories</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-card rounded-lg shadow border border-border p-4 md:p-6">
          <div className="flex justify-between pb-4 mb-4 border-b border-border">
            <div className="flex items-center">
              ...
              <div>
                <h5 className="leading-none text-xl font-bold text-foreground pb-1">Category Breakdown</h5>
          ...
          <div className="flex justify-between items-start w-full mb-4">
            <div className="flex-col items-center">
              <div className="flex items-center mb-1">
                <h5 className="text-xl font-bold leading-none text-foreground me-1">Category Distribution</h5>
              </div>
              <p className="text-sm font-normal text-muted-foreground">Percentage breakdown</p>
            </div>
          </div>
        ...
        <div className="bg-card rounded-lg shadow border border-border p-4 md:p-6">
          <div className="flex justify-between pb-4 mb-4 border-b border-border">
            <div className="flex items-center">
              ...
              <div>
                <h5 className="leading-none text-xl font-bold text-foreground pb-1">Weekly Pattern</h5>
        ...
        <div className="bg-card rounded-lg shadow border border-border p-4 md:p-6">
          <div className="flex justify-between pb-4 mb-4 border-b border-border">
            <div className="flex items-center">
              ...
              <div>
                <h5 className="leading-none text-xl font-bold text-foreground pb-1">Budget vs Actual</h5>
                <p className="text-sm font-normal text-muted-foreground">Performance comparison</p>
              </div>
            </div>
          </div>
